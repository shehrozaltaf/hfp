...
class Vaccination_report_Model extends Model
{
	...
	SUM (CASE WHEN pd.vs306a=1 THEN 1 ELSE 0 END) AS bcg,
    SUM (CASE WHEN pd.vs306b=2 THEN 1 ELSE 0 END) AS opv,
    SUM (CASE WHEN pd.vs306c=3 THEN 1 ELSE 0 END) AS pcv,
    SUM (CASE WHEN pd.vs306d=4 THEN 1 ELSE 0 END) AS penta,
    SUM (CASE WHEN pd.vs306e=5 THEN 1 ELSE 0 END) AS rota,
    SUM (CASE WHEN pd.vs306f=6 THEN 1 ELSE 0 END) AS ipv,
    SUM (CASE WHEN pd.vs306g=7 THEN 1 ELSE 0 END) AS measles,
