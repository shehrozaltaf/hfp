...
class Diagnosis_report extends Controller
{
    ...
    public function index()
    {
        ...
        $data['permission'] = Settings_Model::getUserRights(Auth::user()->idGroup, '', 'diagnosis_report');
        /*==========Log=============*/
        $trackarray = array(
            "activityName" => "Diagnosis_report",
            "action" => "View Diagnosis_report -> Function: Diagnosis_report/index()",
            "PostData" => "",
            "affectedKey" => "",
            "idUser" => Auth::user()->id,
