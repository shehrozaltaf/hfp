...
use App\Models\Vaccination_report_Model;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;

class Vaccination_report extends Controller
{
    ...
    public function index()
    {
        ...
        $data['permission'] = Settings_Model::getUserRights(Auth::user()->idGroup, '', 'vaccination_report');
        /*==========Log=============*/
        $trackarray = array(
            "activityName" => "Vaccination_report",
            "action" => "View Vaccination_report -> Function: Vaccination_report/index()",
            "PostData" => "",
            "affectedKey" => "",
            "idUser" => Auth::user()->id,
