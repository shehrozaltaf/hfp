            ...
            <div class="col-sm-12">
                <div class="slideshow-container">
                    ...
                    <div class="mySlides fade">
                        ...
                        <img src="{{asset('public/slider_imgs/i'.$i.'.jpeg')}}" style="width:100%">
                 ...
                 <div class="card">
                    ...
                    <div class="card-body">
                        <div class="owl-carousel owl-theme" id="owl-carousel-2"  >
                            <?php for($i=1;$i<=10;$i++){ ?>
                            <div class="item"><img class="owlCarouselimg img-responsive img-fluid" src="{{asset('public/slider_imgs/i'.$i.'.jpeg')}}"  alt=""></div>
                            <?php }?>
                        </div>
                    </div>
                </div>
